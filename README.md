...
jobs:
  readme_edit:
    ...
    - name: Adds Sponors to README
      run: |
        gleam_contributors/_build/default/bin/gleam_contributors readme-list $API_TOKEN README.md
...
```sh
_build/default/bin/gleam_contributors readme-list $TOKEN $FILENAME
```
